...
class image extends Panel 
{
	...
	public image() {
		...
		try {
  File input = new File("C:\\Users\\Omkar Borker\\OneDrive\\Pictures\\Screenshots\\test.png");
...
class Chatbot extends JFrame {
		...
		b.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(e.getSource() == b) {                           // Message sent on Click button
					...
					if(text.contains("hi")||text.contains("hello")) {                         // input Checking
					...
					else if(text.contains("what is your name")||text.contains("whats your name")||text.contains("you name?")) {
						if(name.contains(" "))
						{
						...
						{
						replymeth("By default i should mention the name of my make-" + name);
						}
					}
					...
					else if(text.contains("tell me a joke")||text.contains("tell me joke")||text.contains("joke"))
					{
					...
					else if(text.contains("bye")||text.contains("gtg")||text.contains("see ya")||text.contains("see you soon")) {
	...
	public void audio(String s) {
		...
		catch(MalformedURLException ex){replymeth("error");};
